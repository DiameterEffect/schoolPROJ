...
public class DiceGameThree
{
    ...
    private static final String player2userName = null;
                ...
                switch (Player1diceSUM) 
                {
                    ...
                    default:
                     ...
                     //once you roll a 7 after establishing a point number,
                        ...
                        String player2userName = "CPU"; 
                        RE_roll(PlayerPOINT, CPUShooterSum, Player1, CPUShooterSum, CPUShooterSum, CPUShooterSum, CPUShooterSum,player2TURN,player2userName);                        
                        flag = false;
                        break;
            ...
            else if (Player1ShooterSum < CPUShooterSum) 
            {
                ...
                switch (Player2diceSUM) 
                {
                    ...
                    default:
                        ...
                        RE_roll(PlayerPOINT2, Player2diceSUM, Player1, RESET_POT_TO_ZERO, Player1ShooterSum, RESET_POT_TO_ZERO, Player2diceSUM,player2TURN,player2userName);
                        flag = false;
                        break;
...
// add it up from there each time they  run the menu
    ...
    public static void RE_roll(int PlayerPOINT,int Player1diceSUM,String Player1, int pot, int Player1BAL, int RESET_POT_TO_ZERO, int Player2BAL,boolean player2TURN, String player2userName2) 
    {
        int DICE1 = 6;
        int DICE2 = 6;
        String Player2username = player2userName2;
        System.out.println(PlayerPOINT);
        boolean flag = true;
        boolean playerT = true;
        //need to verify if its player 2 turn
        //cpu turn
        // Player2username is CPU for when player plays againist CPU if not then Player2username = Player2 userNAME
        ...
        while (playerT) 
        {
            ...
            System.out.println(Player2username+" rolled " + Player2diceSUM);
            //If they roll it first, if not they lose
            if (Player2diceSUM == PlayerPOINT) 
            {
                System.out.println(Player2username+" rolled " + Player2diceSUM);
                System.out.println(Player2username+" win!");
                System.out.println(Player2username+" gets the pot!");
                ...
                //displays current values of the player and CPU
                System.out.println(Player2username+" now has " + Player2BAL + " and " + Player1 + " now has " + Player1BAL);
            ...
            {
                System.out.println(Player2username +" lost the pot and now" +Player1+" is the shooter");
        ...
        if (player2TURN == true) 
        {
            ...
            while (playerT) 
            {
                ...
                System.out.println(Player2username+" rolled " + Player1diceSUM);
                //If they roll it first, if not they lose
                ...
                {
                    System.out.println(Player2username+" lost the pot and now CPU is the shooter");
